...
func LockVC(s *discordgo.Session, i *discordgo.InteractionCreate) {
	...
	// Lock permissions
	if err := setLockPerms(s, customVc.ID, i.GuildID, settings.VoiceExceptionRoleIDs); err != nil {
...
func setLockPerms(s *discordgo.Session, channelID, guildID string, roleIDs []string) error {
